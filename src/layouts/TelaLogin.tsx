        ...
        <ScrollView>
            <View style={styles.telaLogin}>
                ...
                <TextInput
                    ...
                    defaultValue="Digite o Login"
                />
                <Text style={styles.titulo2}>Digite a senha</Text>

                <TextInput
                    style={[styles.caixa_texto, styles.largura_70]}
                    defaultValue="Digite a senha"
                />
            ...
            <View style={{ alignItems: 'center' }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center', marginTop: 10 }}>
                    ...
                    <Pressable style={(state) => [styles.botao, state.pressed ? { opacity: 0.5 } : null]}>
                        <View>
                            <Text style={styles.desc_botao}>Esqueceu senha</Text>
                        </View>
                    </Pressable>
                </View>
            </View>
